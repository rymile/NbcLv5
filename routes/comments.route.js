...
router.post("/posts/:postId/comments", commentsController.createComments);
router.put("/comments/:commentId", commentsController.putComments);
router.delete("/comments/:commentId", commentsController.deleteComments);
